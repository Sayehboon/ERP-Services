...
public class BankAccountConfiguration : IEntityTypeConfiguration<BankAccount>
{
    public void Configure(EntityTypeBuilder<BankAccount> builder)
    {
        ...
        builder.Property(p => p.AccountName).HasMaxLength(200).IsRequired();
        ...
        builder.HasIndex(p => new { p.BusinessId, p.AccountName }).IsUnique().HasDatabaseName("IX_BankAccounts_Business_Name");
