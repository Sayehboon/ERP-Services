...
public sealed class GetRecentActivitiesQueryHandler : IRequestHandler<GetRecentActivitiesQuery, IEnumerable<RecentActivityDto>>
{
    ...
    /// </summary>
    public async Task<IEnumerable<RecentActivityDto>> Handle(GetRecentActivitiesQuery request, CancellationToken cancellationToken)
    {
        ...
        return activities.OrderByDescending(a => a.Timestamp).Take(request.Count);
    }
